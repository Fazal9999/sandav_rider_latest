...
mixin _$SearchDelegateOb on _SearchDelagateOb, Store {
  final _$sliderInitialIndexAtom =
      Atom(name: '_SearchDelagateOb.sliderInitialIndex');
  ...
  final _$list_of_imageAtom = Atom(name: '_SearchDelagateOb.list_of_image');
  ...
  final _$bgColorAtom = Atom(name: '_SearchDelagateOb.bgColor');
  ...
  final _$textColorAtom = Atom(name: '_SearchDelagateOb.textColor');
  ...
  final _$_SearchDelagateObActionController =
      ActionController(name: '_SearchDelagateOb');
