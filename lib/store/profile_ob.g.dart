...
mixin _$ProfileOb on _ProfileOb, Store {
   final _$pickedFileAtom =
      Atom(name: '_ProfileOb.pickedFile');
  ...
  set pickedFile(XFile value) {
   ...
   final _$pickedValuseOfDropDownMenu1Atom =
      Atom(name: '_ProfileOb.pickedValuseOfDropDownMenu1');
  ...
  set pickedValuseOfDropDownMenu1(double value) {
   ...
   final _$pickedValuseOfDropDownMenu2Atom =
      Atom(name: '_ProfileOb.pickedValuseOfDropDownMenu2');
  ...
  set pickedValuseOfDropDownMenu2(double value) {
   ...
   final _$pickImageAsyncAction =
      AsyncAction('_ProfileOb.pickImage');
