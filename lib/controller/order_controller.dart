...
import 'package:sandav/data/model/response/distance_model.dart';
import 'package:sandav/data/model/response/order_details_model.dart';
...
import 'package:sandav/data/model/response/timeslote_model.dart';
import 'package:sandav/data/model/response/userinfo_model.dart';
...
class OrderController extends GetxController implements GetxService {
  ...
  Future<void> placeAvailability(
    ...
    Response response = await orderRepo.placeAvailability(availability);
    _isLoading = false;
    if (response.statusCode == 200) {
      String message = response.body['message'];
