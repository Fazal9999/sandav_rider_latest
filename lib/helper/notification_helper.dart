...
class NotificationHelper {
  static Future<void> initialize(
    ...
    flutterLocalNotificationsPlugin.initialize(initializationsSettings,
      ...
      try {
        ...
        if (payload != null && payload.isNotEmpty) {
          ...
          else if (_payload.notificationType == NotificationType.status) {
            Get.toNamed(RouteHelper.getNotificationRoute());
          }
          else {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      print("Fazallll ${message.data['type']}");
      ...
      try {
        if (message.data != null || message.data.isNotEmpty) {
          ...
          if (_notificationBody.notificationType == NotificationType.order) {
            print('refnew ${message.data['description']}');
            if(message.data['order_id']==0){
              Get.toNamed(RouteHelper.getNotificationRoute());
            }else{
              Get.toNamed(RouteHelper.getOrderDetailsRoute(
          ...
          else if (_notificationBody.notificationType == NotificationType.status) {
            print('order call-------------');
            Get.toNamed(RouteHelper.getNotificationRoute());
          }
