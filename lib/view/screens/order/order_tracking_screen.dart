...
import 'package:sandav/view/screens/order/widget/track_details_view.dart';
import 'package:sandav/view/screens/order/widget/tracking_stepper_widget.dart';
  ...
  void setMarker(Restaurant restaurant, DeliveryMan deliveryMan,
    ...
    try {
      Uint8List restaurantImageData =
          await convertAssetToUnit8List(store, width: 100);
      Uint8List deliveryBoyImageData =
          await convertAssetToUnit8List(delivery_man_marker, width: 100);
      Uint8List destinationImageData = await convertAssetToUnit8List(
        takeAway ? my_location_marker : user_marker,
