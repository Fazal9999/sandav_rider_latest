...
import 'package:sandav/view/screens/order/widget/order_product_widget.dart';
import 'package:sandav/view/screens/review/rate_review_screen.dart';
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen>
  ...
  void _loadData() async {
    await Get.find<OrderController>().trackOrder(widget.orderId.toString(),
        widget.orderModel != null ? widget.orderModel : null, false);
                          ...
                          child: Container(
                            ...
                            child: CustomButton(
                              ...
                              onPressed: () async {
                                ...
                                orderController.cancelTimer();
                                await Get.toNamed(RouteHelper.getReviewRoute(),
