...
import 'package:sandav/view/screens/home/widget/restaurant_details_sheet.dart';
...
class _MapViewScreenState extends State<MapViewScreen> {
  ...
  Widget _customMarker(String path) {
    return Stack(
      children: [
        Image.asset(location_marker, height: 40, width: 40,
         color: Colors.red,
  ...
  void _setMarkers(List<Restaurant> restaurants) async {
    ...
    _customMarkers.add(MarkerData(
      ...
      child: Image.asset(my_location_marker, height: 20, width: 20,
      color: Colors.red,
      ),
    ));
    int _index = 0;
