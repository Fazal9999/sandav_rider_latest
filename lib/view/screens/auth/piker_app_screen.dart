...
void main() => runApp(PickerAppScreen());

class PickerAppScreen extends StatefulWidget {
  @override
  _PickerAppScreenState createState() => _PickerAppScreenState();
}
class _PickerAppScreenState extends State<PickerAppScreen> {
  String _path = '-';
