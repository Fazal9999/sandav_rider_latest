...
import 'package:sandav/view/screens/chat/widget/image_dialog.dart';
...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool _isReply = message.senderId !=
                  ...
                  children: [
                    ClipRRect(
                      child: CustomImage(
                        ...
                        height: 40,
                        image:
                            '${userType == UserType.admin ? _baseUrl.businessLogoUrl : userType == UserType.vendor ? _baseUrl.restaurantImageUrl : _baseUrl.deliveryManImageUrl}/${user.image}',
                      ),
                          ...
                          ClipRRect(
                            ...
                            child: CustomImage(
                              ...
                              image: profileController.userInfoModel != null
                                  ? '${_baseUrl.customerImageUrl}/${profileController.userInfoModel.image}'
                                  : '',
                            ),
                          ),
                        ]),
